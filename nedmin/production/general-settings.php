                            ...
                            <form action="../netting/actions.php" method="POST" id="demo-form2" data-parsley-validate
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="first-name" name="settingTitle"
                                            value="<?php echo $company['settingTitle'] ?>" required="required"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="first-name"
                                            value=" <?php echo $company['settingDescription'] ?>"
                                            name="settingDescription" required="required"
                                            class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="first-name"
                                            value=" <?php echo $company['settingAuthor'] ?>" name="settingAuthor"
